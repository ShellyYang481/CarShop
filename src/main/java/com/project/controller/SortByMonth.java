 ...
 */
@WebServlet("/SortByMonth")
public class SortByMonth extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			ArrayList<NewsBean> newses = newsDao.queryTableByMonth(request.getParameter("start"), request.getParameter("end"));
